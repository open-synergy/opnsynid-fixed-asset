...
class FixedAssetRetirementStolen(models.Model):
    ...
    def _default_type_id(self):
        return self.env.ref(
            "fixed_asset_retirement_stolen." "retirement_type_stolen"
        ).id
    ...
    def search(self, args, offset=0, limit=None, order=None, count=False):
        type_id = (
            self.env.ref(
                "fixed_asset_retirement_stolen." "retirement_type_stolen", False
            )
            and self.env.ref("fixed_asset_retirement_stolen." "retirement_type_stolen")
