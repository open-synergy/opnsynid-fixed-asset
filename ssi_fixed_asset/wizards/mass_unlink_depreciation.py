...
class AccountMassUnlinkDepreciation(models.TransientModel):
    _name = "account.mass_unlink_depreciation"
    _description = "Mass Unlink Depreciation"
    ...
    def action_confirm(self):
        for wizard in self.sudo():
            wizard._mass_unlink_depreciate()

    def _mass_unlink_depreciate(self):
        self.ensure_one()
