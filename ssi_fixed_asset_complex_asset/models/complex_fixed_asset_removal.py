...
class ComplexFixedAssetRemoval(models.Model):
    _name = "complex_fixed_asset_removal"
    _description = "Complex Fixed Asset Removal"
    _inherit = [
    ...
    def _get_policy_field(self):
        res = super(ComplexFixedAssetRemoval, self)._get_policy_field()
        policy_field = [
            "confirm_ok",
            "approve_ok",
            "done_ok",
