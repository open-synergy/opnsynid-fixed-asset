...
class FixedAssetYearlyXslx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        row = 1
        worksheet.merge_range(f'A{row}:X{row}', f'Fixed Asset Yearly - {data["company_name"]} - {data["currency_name"]}', wbf['title_doc'])
        ...
        for category in data['fixed_asset_yearly']:
            worksheet.merge_range(f'A{row}:B{row}', category['category_name'], wbf['content_bold'])
            ...
            for asset in category['assets']:
                ...
                worksheet.write(row, 3, asset['acquisition_value'], wbf['content_float'])
                worksheet.write(row, 4, asset['vendor'], wbf['content'])
                ...
                worksheet.write(row, 8, asset['nbv_previous_year'], wbf['content_float'])
                worksheet.write(row, 9, asset['dpr_previous_year'], wbf['content_float'])
                ...
                worksheet.write(row, 22, asset['dpr_current_year'], wbf['content_float'])
                worksheet.write(row, 23, asset['nbv_current_year'], wbf['content_float'])
                row += 1
            row += 2
