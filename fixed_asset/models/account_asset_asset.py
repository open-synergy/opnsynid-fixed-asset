...
class AccountAssetAsset(models.Model):
    ...
    def _value_get(self):
        ...
        for child in self.child_ids:
            asset_value += \
                child.type == "normal" and \
                child._asset_value_compute() \
                or child._value_get()
        return asset_value
    ...
    def _compute_entries(self, period_id, check_triggers=False):
        ...
        if check_triggers:
            ...
            recompute_ids = \
                obj_asset_recompute.sudo().search([("state", "=", "open")])
            if recompute_ids:
    ...
    def validate(self):
        for document in self:
            ...
            if document.type == "normal" and currency.is_zero(
                    document.value_residual):
